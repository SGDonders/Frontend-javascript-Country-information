...
async function fetchData() {
    try {
        ...
        const axiosResponse = await (0, _axiosDefault.default).get("https://restcountries.com/v2/all");
        ...
        if (error.status === 404) errorMessage.textContent = "Page not found | 404";
        if (error.status === 500) errorMessage.textContent = "Internal server error | 500";
    }
}
fetchData();
//----------------------------------------------------------------------------------------------------------------------
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7Aums","bNKaB"], "bNKaB", "parcelRequirecb08")

//# sourceMappingURL=search.0641b553.js.map
